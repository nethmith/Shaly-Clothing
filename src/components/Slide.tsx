...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
    return (
        <div className='outline-none border-none relative'>
            ...
            -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-8 rounded-lg
            sm:rounded-none">
                ...
                <h3 className='text-[24px] text-gray-500'>
                    starting at{" "}
                    <b className='text-[24px] md:text-[24px] lg:text-[30px]'>{price}</b>
                    .00
                </h3>
            ...
            <Image className='w-[100%] h-[300px] md:h-auto rounded-xl object-cover object-right md:right-left-bottom'
                src={img}
                width={2000}
                height={2000} alt={''} />
        </div>
